abstract class PicsManager {
  static const String _base="lib/core/images/";
...
abstract class IconManager{
  static const String _base="lib/core/images/";
  static const String quran="${_base}Vector-1.png";
  static const String time="${_base}ic_time.png";
  static const String sebha="${_base}ic_sebha.png";
  static const String radio="${_base}ic_radio.png";
  static const String hadeth="${_base}ic_hadeth.png";
